...
Router.route('/avatar')
  .put(verifyToken, authorizeAdmin('user'), uploadUserAvatar.single('avatar'), userController.updateUserById)
  .post(verifyToken, authorizeAdmin('user'), uploadUserAvatar.single('avatar'), userController.uploadAvatarById)
